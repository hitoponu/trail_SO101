...
現在の仮初期値は、公式STLの幾何計算から得た次の値です。
ただし **D405 + Wrist_Roll_D405_Holder 前提で、D435iの実測値ではありません**。

```dotenv
WRIST_CAMERA_X=0.0
WRIST_CAMERA_Y=-0.07112
WRIST_CAMERA_Z=-0.02074
WRIST_CAMERA_ROLL=3.14159
WRIST_CAMERA_PITCH=1.13445
WRIST_CAMERA_YAW=1.57080
```
